    ...
    component: () => (
        <div className="min-h-screen bg-gray-900 text-gray-50">
            <header className='flex justify-between p-4 bg-slate-800'>
                <h1 className='text-5xl'>Assignment 4</h1>
                <nav className='text-3xl space-x-4 m-2'>
                    <Link to="/" className="[&.active]:font-bold">Home</Link>
                    <Link to="/about" className="[&.active]:font-bold">About</Link>
                    <Link to="/effect-challenge" className="[&.active]:font-bold">Effect</Link>
                    <Link to="/state-challenge" className="[&.active]:font-bold">Cart</Link>
